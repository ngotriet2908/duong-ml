...
from src.net.dense3_skip2 import Generator, Discriminator
...
scorepath = os.path.join(os.getcwd(), f"output/result_{time.isoformat(timespec='minutes')}")
...
path_gen = os.path.join(os.getcwd(), "output/result_2020-06-18T17:12/gen_CWGAN-GP_model_Dense3_concat_fx.pt")
path_dis = os.path.join(os.getcwd(), "output/result_2020-06-18T17:12/dis_CWGAN-GP_model_Dense3_concat_fx.pt")
